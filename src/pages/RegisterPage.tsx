      ...
      >
        ...
        <div className="border border-border-warm bg-bg-card rounded-lg p-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h2 className="font-heading text-xl text-text-main">注册</h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-body text-text-body mb-1.5">
                姓名
              </label>
              <input
                id="name"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-body text-text-body mb-1.5">
                确认密码
              </label>
              <input
                id="confirmPassword"
          ...
          <p className="text-center text-sm text-text-muted mt-6 font-body">
            已有账号？{' '}
            <Link to="/auth/login" className="text-red-primary hover:text-red-dark transition-colors">
              登录
            </Link>
          </p>
        </div>
